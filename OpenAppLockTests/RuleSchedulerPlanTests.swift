...
struct RuleSchedulerPlanTests {
    ...
    func limitPlanOpenLimit() throws {
        ...
        let plan = scheduler.openLimitRulePlannedActivity(for: rule.dto, selectionData: Data([1]))
    ...
    func limitPlanFingerprintTracksConfiguration() throws {
        ...
        let fingerprint = scheduler.openLimitRulePlannedActivity(for: rule.dto, selectionData: Data([1])).fingerprint
        ...
        #expect(scheduler.openLimitRulePlannedActivity(for: rule.dto, selectionData: Data([1])).fingerprint == fingerprint)
    ...
    func schedulePlansNonCrossing() throws {
        ...
        let plans = scheduler.scheduleRuleSnapshotPlannedActivities(for: rule.dto)
